...
<section class="content-header">
              ...
              <table id="tableVentas" class="table table-bordered table-striped">
                ...
                <tbody>
                  @foreach($Ventas as $venta)
                    <tr>
                       <th>{{$venta->id}}</th>
                       <th>{{$venta->cliente->nombre}}</th>
                       <th>{{$venta->total}}</th>
                       <th>{{$venta->subtotal}}</th>
                       <th>{{$venta->debe}}</th>
                       <th>{{$venta->pagado}}</th>
                       @if($venta->estado == 'Impaga')
                       ...
                       @endif
                       <th>
                         <form class="" action="getVenta" method="POST" target="_blank">
                            {{ csrf_field() }}
        ...
        $(document).ready(function(){
          ...
          $("#cliente").easyAutocomplete(options);
            ...
            $('#saveItem').click(function(){
                 ...
                 var results = $('#tableVenta').DataTable();
    ...
    $('#tableProductos').DataTable( {
        ...
        select: {
            ...
            $("#tableVenta").on('click', '.btnDelete', function () {
                var results = $('#tableVenta').DataTable();
                    results
                     .row( $(this).parents('tr') )
                     .remove()
            ...
            $("#tableVenta").on('change', '.cantidadProducto', function () {
                var results = $('#tableVenta').DataTable();
                ...
                results.row( $(this).parents('tr')).every(function (rowIdx, tableLoop, rowLoop) {
                   results.cell(rowIdx,7).data(subTotal.toFixed(2));
        ...
        <div class="modal-dialog bs-example-modal-lg modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">ABM Ventas</h4>
                </div>
                ...
                <div class="modal-body" style="height: 450px;overflow-y: auto;">
                        ...
                        <div class="tab-content">
                            ...
                            <div class="active tab-pane" id="Factura">
                              <form id="formVenta"  action="addVenta" method="GET" target="_blank">
                                 {{ csrf_field() }}
                            ...
                            <div class="col-lg-12">
                                ...
                                <table id="tableVenta" class="table table-bordered table-striped">
                ...
                <div class="modal-footer">
                    ...
                    <input type="hidden" value="0.00" name="TotalVenta" id="TotalVenta">
                    ...
                    <button type="button" class="btn btn-primary" id="SendVenta">Crear Venta</button>
                </div>
